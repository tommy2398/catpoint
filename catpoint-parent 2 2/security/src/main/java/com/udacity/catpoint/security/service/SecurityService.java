...
public class SecurityService {
    ...
    public void setArmingStatus(ArmingStatus armingStatus) {
         if (armingStatus == ArmingStatus.DISARMED) {
            setAlarmStatus(AlarmStatus.NO_ALARM);
             ...
             if (currentImageHasCat && armingStatus == ArmingStatus.ARMED_HOME) {
    ...
    private void catDetected(Boolean cat) {
        ...
        if(cat && getArmingStatus() == ArmingStatus.ARMED_HOME) {
            ...
            // If the camera image does not contain a cat, change the status to no alarm as long as the sensors
            // are not active.
            if (!hasActiveSensors()) {
                setAlarmStatus(AlarmStatus.NO_ALARM);
            }
    ...
    /**
     * Internal method that returns true if there is any sensor
     * with active status.
     */
